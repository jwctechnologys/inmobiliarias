...
function VerContratos() {
  ...
  return (
    <div className="ver-contratos">
      ...
      <h2>Ver Contratos</h2>
      <div>
        <label htmlFor="contrato">Seleccionar contrato Local/Vivienda:</label>
