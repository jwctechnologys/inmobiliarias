...
function VerContratoComercial() {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_BASE_URL}/api/Contrato_Local_viviendaViewSet/?tipoContrato=local comercial`)
  ...
  return (
    <div className="ver-contratos">
      ...
      <h2>Ver Contratos</h2>
      <div>
        <label htmlFor="contrato">Seleccionar contrato comercial:</label>
...
export default VerContratoComercial;
